...
export const metadata: Metadata = {
  ...
  description:
    "База знаний Пропочву: уход за комнатными растениями, органические удобрения, грунты и вертикальное озеленение. Рубрики, подборки и статьи от КФХ «Ранчо Мушкино».",
