...
export const metadata: Metadata = {
  title: "О бренде ЭКО Конь и Цветология | Пропочву",
  description:
    "История бренда органических удобрений ЭКО Конь и систем вертикального озеленения Цветология. Ферма «Ранчо Мушкино», Калининградская область.",
...
const timeline = [
  { year: "2014", text: "Первые эксперименты с ферментацией конского навоза на ферме" },
  ...
  { year: "2024", text: "500 000 довольных клиентов, рейтинг 4.9 на маркетплейсах" },
    ...
    <div className="container-main section-padding">
      ...
      <div className="mb-16">
        ...
        <p className="mt-6 max-w-2xl text-lg text-ink-2 leading-relaxed">
          Ферма «Ранчо Мушкино» производит органические удобрения на основе
          конского навоза с 2014 года, а с 2022 года — и системы вертикального
          озеленения «Цветология».
        </p>
      </div>
      ...
      <div className="mb-16">
        <div className="rounded-lg border border-line bg-cream/50 p-7">
          ...
          <p className="text-sm leading-relaxed text-ink-2 mb-2">
            ...
            принадлежат ООО «Цветология» (ИНН 3900034368).
          </p>
          <p className="text-sm text-mute">
            © ООО «Цветология». Все права защищены.
          </p>
        </div>
      </div>
