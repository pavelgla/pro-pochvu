      ...
      <div className="space-y-10 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <ul className="mb-4 list-disc space-y-2 pl-6">
            ...
            <li>
              <span className="font-medium">Сервис онлайн-консультанта:</span> ConOmni
              (серверы на территории России) — текст переписки в чате на сайте,
              техническая информация браузера и cookie сервиса. Данные обрабатываются
              для ответа на ваш вопрос; писать в чат — ваше решение, оставлять в нём
              контакты и подробности заказа не обязательно
            </li>
          </ul>
