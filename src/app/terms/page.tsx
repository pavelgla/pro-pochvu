...
export default function TermsPage() {
  return (
    <div className="container-main section-padding max-w-3xl">
      ...
      <p className="mb-1 text-sm text-gray-500">Редакция от 15.07.2026</p>
      ...
      <div className="space-y-10 text-gray-700 leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc space-y-2 pl-6">
            ...
            <li>
              Цены указаны в рублях РФ. Продавец применяет упрощённую систему
              налогообложения, НДС не облагается
            </li>
            <li>
              Оплата: онлайн через сервис ЮKassa — банковская карта, СБП,
              SberPay, T-Pay, рассрочка
            </li>
        ...
        <section>
          ...
          <ul className="list-disc space-y-2 pl-6">
            <li>
              Доставка заказов, оформленных на сайте, осуществляется до пункта
              выдачи Ozon (сервис «Озон-доставка»). Стоимость и условия доставки
              указываются при оформлении заказа и на странице{" "}
            ...
            <li>
              Товары также доступны на маркетплейсах Wildberries и Ozon — в этом
              случае сроки, стоимость и способы доставки определяются правилами
